...
public:
  ...
  static ClassScopeContainer *CreateContainer(string *id, vector<string *> variables,  vector<ConstDeclNode *> consts, vector<string *> extended, vector<string *> included, vector<string *> traits, vector<FunctionStmtDeclNode *> functions);
};