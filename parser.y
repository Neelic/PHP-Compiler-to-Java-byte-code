...
start:    START_CODE_PHP_TAG top_stmt_list_not_e                                      {$$=StartNode::Create($2);}                     
        | START_CODE_PHP_TAG top_stmt_list_not_e END_CODE_PHP_TAG                     {$$=StartNode::Create($2);}
        | START_CODE_PHP_TAG top_stmt_list_not_e END_CODE_PHP_TAG HTML                {$$=StartNode::Create($2);}
        | HTML START_CODE_PHP_TAG top_stmt_list_not_e                                 {$$=StartNode::Create($3);}
        | HTML START_CODE_PHP_TAG top_stmt_list_not_e END_CODE_PHP_TAG                {$$=StartNode::Create($3);}
        | HTML START_CODE_PHP_TAG top_stmt_list_not_e END_CODE_PHP_TAG HTML           {$$=StartNode::Create($3);}
        | START_CODE_PHP_TAG                                                          {}
