...
public:
    ...
    static ExprNode *CreateFromInstanceOf(ExprNode *left, ExprNode *right);
    ...
    static ExprNode *
    CreateFromGetValueWithExprReference(ExprNode *left, GetValueNode *get_value, ExprNode *get_value_expr);

    static ExprNode *CreateFromMethodReference(ExprNode *left, std::string *id, ExprList *listParams);

    static ExprNode *
    CreateFromGetValueMethodReference(ExprNode *left, GetValueNode *get_value, std::string *id, ExprList *listParams);

    static ExprNode *CreateFromGetValueWithExprMethodReference(ExprNode *left, GetValueNode *get_value, std::string *id,
    ...
    static ExprNode *
    CreateFromGetValueWithExprReferenceDots(ExprNode *left, GetValueNode *get_value, ExprNode *get_value_expr);

    static ExprNode *CreateFromMethodReferenceDots(ExprNode *left, std::string *id, ExprList *list);

    static ExprNode *CreateFromGetValueMethodReferenceDots(ExprNode *left, GetValueNode *get_value, std::string *id,
                                                           ExprList *listParams);
